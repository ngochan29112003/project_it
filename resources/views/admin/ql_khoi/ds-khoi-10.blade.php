                ...
                <div class="col-12">
                    <div class="card">
                        <div class="table-responsive p-2">
                            <table id="tableKhoi-10" class="table table-vcenter card-table table-striped">
                                <thead>
                                <tr>
                                    <th>STT</th>
                                    <th>Mã Lớp</th>
...
@section('scripts')
    <script>
        var table = $('#tableKhoi-10').DataTable({
            "language": {
                "emptyTable": "Không có dữ liệu trong bảng",
                "search": "Tìm kiếm:",
                "lengthMenu": "Hiển thị _MENU_ khối 10 mỗi trang",
