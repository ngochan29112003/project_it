...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 20, 2024 lúc 05:05 AM
...
--
-- Cấu trúc bảng cho bảng `bai_lam_sinh_vien`
--
...
--
-- Đang đổ dữ liệu cho bảng `bai_lam_sinh_vien`
--
...
--
-- Đang đổ dữ liệu cho bảng `bai_tap_files`
--
...
--
-- Cấu trúc bảng cho bảng `ngan_hang_cau_hoi`
--
...
--
-- Đang đổ dữ liệu cho bảng `ngan_hang_cau_hoi`
--
...
--
-- Chỉ mục cho bảng `bai_lam_sinh_vien`
--
...
--
-- Chỉ mục cho bảng `bai_tap_files`
--
...
--
-- Chỉ mục cho bảng `ngan_hang_cau_hoi`
--
...
--
-- AUTO_INCREMENT cho bảng `bai_lam_sinh_vien`
--
ALTER TABLE `bai_lam_sinh_vien`
...
--
ALTER TABLE `bai_tap`
  MODIFY `ma_bai_tap` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT cho bảng `bai_tap_files`
--
ALTER TABLE `bai_tap_files`
...
--
-- AUTO_INCREMENT cho bảng `ngan_hang_cau_hoi`
--
ALTER TABLE `ngan_hang_cau_hoi`
